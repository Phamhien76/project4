    ...
    <section class="home-section">
        <div class="home-content">
            ...
            <div>
                <nav class="nav">
                    <div class="create">
                        <a class="btn btn-warning btn-xs" href="<%=request.getContextPath()%>/views/admin/newCategories.jsp" >Add</a>
                    </div>
            ...
            <div class="page">
                <a class="btn btn-warning btn-xs" href="<%=request.getContextPath()%>/categoriesController/findAll?page=1&sortBy=id&sortDir=ASC" >Back</a>
