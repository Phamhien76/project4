        ...
        <form action="<%=request.getContextPath()%>/productController/update" method="post" >
            <div class="modal-body">
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="id" name="id" value="${updateProduct.id}"/>
                    </div>
                </div>
                <div class="mb-3 row">
                    <label for="name" class="col-sm-3 col-form-label" >Product name</label>
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="name" name="name" value="${updateProduct.name}"/>
                    </div>
                </div>
                <div class="mb-3 row">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="title" name="title" value="${updateProduct.title}"/>
                    </div>
                </div>
                <div class="mb-3 row">
                    <label for="description" class="col-sm-3 col-form-label" >Description</label>
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="description" name="description" value="${updateProduct.description}"/>
                    </div>
                </div>
                <div class="mb-3 row">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-9">
                        <input type="radio" name="status" id="active" value="true"${updateProduct.status?"checked":""} /><label for="active">Active</label>
                        <input type="radio" name="status" id="inactive" value="false"${updateProduct.status?"":"checked"} /><label for="inactive">Inactive</label>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="submit" class="btn btn-primary" id="btnCreateStudent" >Save</button>
                    <a href=<%=request.getContextPath()%>/productController/findAll"  class="btn btn-secondary" >Cancel</a>
                </div>
            </div>
        </form>
    </div>
